...
CREATE TABLE `issue` (
	...
	CONSTRAINT `issue_category_id` FOREIGN KEY (`category_id`) REFERENCES `issue_category`(`id`) ON UPDATE CASCADE ON DELETE RESTRICT,
...
SELECT
	...
	`issue`.`category_id` AS `category_id`,
